...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 82d1af217). Confidence: 100%.
...
- `lib/features/admin/presentation/widgets/create_lesson_dialog.dart` — 21 bug fixes, last fix 5 days ago (bug magnet); 14 commits/90d
- `server/src/crm/schedule/schedule-plan-postgres.integration.spec.ts` — 17 bug fixes, last fix 5 days ago (bug magnet); 26 commits/90d
- `server/src/crm/crm.service.ts` — 27 bug fixes, last fix 8 weeks ago (bug magnet); 7 commits/90d
- `lib/features/crm/presentation/client_card/client_card.dart` — 16 bug fixes, last fix 11 days ago (bug magnet); 15 commits/90d
- `server/src/crm/crm.service.spec.ts` — 22 bug fixes, last fix 8 weeks ago (bug magnet); 12 commits/90d

### Code health
Three co-equal signals: defect risk 7.46/10 avg, hotspot health 5.35/10 (stable), worst `lib/features/admin/presentation/widgets/lesson_editor/lesson_editor_decision_policy.dart` at 1.0/10 · maintainability 8.52/10 · performance risk 105 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `tool/naming_exceptions.json` — change entropy — impact −2.8

...
> Рабочая ветка: `codex/adaptive-window-layout`
> Статус: hotfix.2 выпущен; исправлены null → 500 в настройках клиентов
> и ложный запрет сохранения заметки занятия

Локальный кандидат окон (ещё не опубликован): общая ширина desktop-форм
728 логических px по образцу «Нового занятия», полная ширина мобильных форм,
адаптивные заголовки и строки расчётов. Исправлены длинные значения в занятии
и отмене абонемента, парные поля оплаты/дат и настройки уведомлений.
Flutter analyze: 0 замечаний; полный Flutter suite: 1565 PASS.
Проверены реальные формы на ширинах 320/390/430/600/1280 с масштабом текста
до 150%, прокрутка, клавиатура, сохранение и dirty-exit guards.
Номер опубликованной версии остаётся `1.5.30+210`; этот кандидат требует
отдельной команды владельца на выпуск.

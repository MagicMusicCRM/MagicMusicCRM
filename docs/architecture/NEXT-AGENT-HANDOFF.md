...
## Локальная переработка клиентской карточки — 22.09.2026, не выпущена
...
`docs/audits/client-card-density-2026-09-22.md`. Это локальный кандидат, не
новый production-релиз и не подтверждение полной приёмки пакета из 20 пунктов.
...
Production, API, схема, update-каналы и версия приложения не изменялись.
Предыдущие release PASS не подтверждают этот новый кандидат. Перед выпуском
нужны отдельная команда владельца и полный release gate.

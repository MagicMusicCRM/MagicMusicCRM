...
- **Предпочтительное расписание** — пожелание или шаблон клиента; это не состоявшееся занятие.
- **Серия занятий** — правило создания связанных занятий.
- **Занятие** — фактическая запись с филиалом, аудиторией, преподавателем, клиентом/группой, временем и жизненным циклом.
- **Конфликт** — структурированное нарушение, которое должен объяснять сервер и визуализировать интерфейс.

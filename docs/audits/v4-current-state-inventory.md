...
**Task:** T8.1.2
**Source digest:** `56c50a4ac5bc23da933da6361399e33dccbe1b853919984f2fc7baf339bbb626`
**Validation:** PASS
...
| backend-route | PATCH /crm/lessons/teacher-rate | `server/src/crm/crm-schedule.controller.ts:244` | commerce-migration-pending |

...
**Task:** T8.1.2
**Source digest:** `185309db96246ebabf40bdf82bfd2e7b00ec6456081e1af6317988b7d4767a89`
**Validation:** PASS
...
| backend-route | PATCH /crm/lessons/teacher-rate | `server/src/crm/crm-schedule.controller.ts:209` | commerce-migration-pending |

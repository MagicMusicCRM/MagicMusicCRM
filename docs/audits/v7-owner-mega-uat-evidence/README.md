...
загружаются один раз, чужие по умолчанию скрыты, выбранные записи и дни зелёные,
после снятия чекбокса остальные становятся видимыми серыми. Production API и БД

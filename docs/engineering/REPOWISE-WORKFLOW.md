...
- Runtime behavior и production evidence сильнее любого сгенерированного
  описания.
- Если RepoWise недоступен, продолжить по живому исходнику через `rg` и чтение
  конкретных файлов; отметить ограничение проверки.
...
3. После серии структурных правок выполнить один раз перед завершением задачи:

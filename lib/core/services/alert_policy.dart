...
///
/// Номера канонические: per-role списки в `crmVisibleTabs` могут пропускать и
/// переставлять вкладки (у admin нет 1, а 6 стоит второй — #17), но само
/// значение индекса не меняется никогда.
class CrmSection {
  static const chat = 0;

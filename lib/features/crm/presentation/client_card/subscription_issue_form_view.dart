    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          ..._discountSection(context, draft, fieldsEnabled),
          ..._surchargeSection(context, draft, fieldsEnabled),
          ..._installmentSection(context, draft, fieldsEnabled),
      ...
      Wrap(
        ...
        children: [
          ...
          SubscriptionIssueModeChip(
            ...
            label: 'Рассрочка',
            selected: draft.fundingMode == SubscriptionFundingMode.installment,
            enabled: fieldsEnabled,
            onSelected: () => _change(
              () => controller.selectFundingMode(
      ...
      Wrap(
        ...
        children: [
          SubscriptionIssueModeChip(
            ...
            label: 'Без скидки',
            selected: draft.discountMode == SubscriptionIssueDiscountMode.none,
            enabled: fieldsEnabled,
            onSelected: () => _change(
          ...
          SubscriptionIssueModeChip(
            ...
            label: 'Сумма',
            selected: draft.discountMode == SubscriptionIssueDiscountMode.fixed,
            enabled: fieldsEnabled,
            onSelected: () => _change(
              () => controller.selectDiscountMode(

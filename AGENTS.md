...
**▶ Следующий шаг:** `/forge` по `.anws/v7/05_TASKS.md`: `T2.1.3` — reversal,
техническое удаление и единый reporting exclusion.
...
- **Активный список задач**: `.anws/v7/05_TASKS.md` — следующая задача `T3.1.5`

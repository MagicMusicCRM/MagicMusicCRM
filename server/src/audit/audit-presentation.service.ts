...
const ENTITY_LABELS: Record<string, string> = {
  ...
  'crm:student': 'Ученик',
  client: 'Клиент',
  client_create_command: 'Команда создания клиента',
  lead: 'Лид',
  'crm:lead': 'Лид',
...
const ACTION_TITLES: Record<string, string> = {
  ...
  'crm.lead_create_committed': 'Создание лида подтверждено',
  ...
  'crm.student_create_committed': 'Создание ученика подтверждено',
  ...
  'crm.schedule_plan_restored': 'План занятий восстановлен из архива',

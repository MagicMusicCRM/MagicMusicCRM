...
describe("capability route policy", () => {
  it.each([
    ...
    ["GET", "/crm/student-funnel", "crm.client.read.basic"],
    ["GET", "/crm/student-funnel/revisions", "system.settings.manage"],
    ["POST", "/crm/student-funnel/publish", "system.settings.manage"],

...
@Module({
  ...
  providers: [CrmService, HomeworkService, ReferenceDataService, SubscriptionsService, RoomsService, BranchesService, CrmPolicy, HolliHopMetadataService, ScheduleSeriesWorker, JwtAuthGuard],

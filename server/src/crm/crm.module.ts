...
@Module({
  ...
  providers: [CrmService, HomeworkService, ReferenceDataService, SubscriptionsService, RoomsService, CrmPolicy, HolliHopMetadataService, ScheduleSeriesWorker, JwtAuthGuard],

...
- [ ] **T9.6** [REQ-V3-AUTH-001, REQ-V3-MSG-001, REQ-V3-FILES-001, REQ-V3-OPS-001]: Stabilize registration, repeated login and mobile chat attachments
  ...
  - **Estimate**: 12 h.
  - **Status**: Approved by the owner on 2026-07-19 after screenshots and code-level diagnosis reproduced the missing phone affordance, keyboard displacement, rejected `image` DTO value, administration-title leak, empty production OTP allowlist and eager login session-clear race.
